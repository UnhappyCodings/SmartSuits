...
public class SmartSuitEditorCapabilityProvider implements ICapabilitySerializable<CompoundTag> {
    ...
    private final SmartSuitEditorItemStackHandler inventory;

    public SmartSuitEditorCapabilityProvider(int basketSize)
    {
        this.inventory = new SmartSuitEditorItemStackHandler(basketSize);
        lazyItemHandler = LazyOptional.of(() -> new SmartSuitEditorItemStackHandler(basketSize));
    }
