package de.unhappycodings.smartsuits.common.network;
...
public class PacketHandler {
    ...
    public static final SimpleChannel CHANNEL = NetworkRegistry.newSimpleChannel(new ResourceLocation(SmartSuits.MOD_ID, "main_channel"), () -> PROTOCOL_VERSION, PROTOCOL_VERSION::equals, PROTOCOL_VERSION::equals);

    private static int index = 0;

    public static void init() {
        registerClientToServer(SmartSuitEditorOpenPacket.class, SmartSuitEditorOpenPacket::decode);
    }
