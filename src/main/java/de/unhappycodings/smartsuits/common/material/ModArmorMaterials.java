package de.unhappycodings.smartsuits.common.material;
...
public enum ModArmorMaterials implements ArmorMaterial {
    SMART("smart", 33, new int[]{4, 7, 9, 4}, 15, SoundEvents.ARMOR_EQUIP_DIAMOND, 2.0F, 0.05F, () -> null);
    ...
    public String getName() {
        return SmartSuits.MOD_ID + ":" + this.name;
    }
